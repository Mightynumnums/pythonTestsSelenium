...
sauceParameters['sauce:options'].update(
    {'build': '-'.join(sauceParameters['sauce:options'].get('tags'))})
...
driver.get('https://www.dryzzz.com/')
shopLink = driver.find_element_by_link_text('Shop')
shopLink.click()


# Setup for finding an element and clicking it
# __________________________________________________________________
interact = driver.find_element_by_id('thumb-sleepy-eyes')
interact.click()
